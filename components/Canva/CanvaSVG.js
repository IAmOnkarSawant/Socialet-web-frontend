      ...
      >
        <defs>
          ...
          <radialGradient
            ...
            cy="0"
            r="1"
            gradientTransform="rotate(-38.85 54.22 -35.3) scale(30.226 20.6676)"
            gradientUnits="userSpaceOnUse"
          >
            <stop stop-color="#6420FF"></stop>
            <stop offset="1" stop-color="#6420FF" stop-opacity="0"></stop>
          ...
          <pattern id="_3141735796__g" width="1" height="1">
            <path fill="#7D2AE7" d="M0 0h100v100H0z"></path>
            <path fill="url(#_3141735796__a)" d="M0 0h100v100H0z"></path>
            <path fill="url(#_3141735796__b)" d="M0 0h100v100H0z"></path>
            <path fill="url(#_3141735796__c)" d="M0 0h100v100H0z"></path>
            <path fill="url(#_3141735796__d)" d="M0 0h100v100H0z"></path>
            <path fill="url(#_3141735796__e)" d="M0 0h100v100H0z"></path>
          </pattern>
        </defs>
        <mask id="_3141735796__f">
          <path
            fill="#fff"
